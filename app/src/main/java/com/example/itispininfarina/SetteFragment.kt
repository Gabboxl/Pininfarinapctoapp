...
class SetteFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val pulsanteFad = layout.findViewById<Button>(R.id.buttonFad)

        pulsanteFad.setOnClickListener {
            val browserIntent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://fad.itispininfarina.it/my/"))
        ...
        pulsanteClassroom.setOnClickListener {
            val browserIntent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://classroom.google.com/h"))
            startActivity(browserIntent)
        }
        ...
        pulsanteOrario.setOnClickListener {
            val browserIntent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://orario.itispininfarina.it/"))
            startActivity(browserIntent)
        }
        ...
        pulsanteCvv.setOnClickListener {
            ...
            val intent =
                requireActivity().packageManager.getLaunchIntentForPackage("eu.spaggiari.classevivafamiglia")
            val intentstudente =
                requireActivity().packageManager.getLaunchIntentForPackage("eu.spaggiari.classevivastudente")
            if (intent != null) {
